...
const Navbar = () => {
  return (
    ...
    <nav className="bg-black p-4 text-white flex flex-col md:flex-row justify-between items-center border-b border-white">
      ...
      <Link to="/sign up">
        <button className="bg-blue-400 text-white px-4 py-1 rounded-full border border-white hover:bg-blue-600">
          Sign up
        </button>
        </Link>
        <Link to="/login">
        <button className="bg-black text-white px-4 py-1 rounded-full border border-white hover:bg-white hover:text-black">
          Login
        </button>
        </Link>
      </div>
